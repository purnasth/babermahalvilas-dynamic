				...
				$.ajax({
				   ...
				   success: function(data){
					   ...
					   if(msg.action=='success'){
						   ...
						   if(actionId==2)
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>articles/list";},3000);						   	
						   if(actionId==1)	
						   	setTimeout( function(){window.location.href="<?php echo ADMIN_URL?>articles/addEdit";},3000);						   	
						   if(actionId==0)
