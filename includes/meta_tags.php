...
function MetaTagsFor_SEO(){
	...
	$seoSources.= '<meta property="og:locale" content="en_US" />'."\n";
	$seoSources.= '<meta property="og:type" content="website" />'."\n";
	$seoSources.= '<meta property="og:title" content="'.$addtitle.$addsep.$sitetitle.'" />'."\n";
	$imgRec = Slideshow::get_latest_slide();
	if(!empty($imgRec)) {
		$seoSources.= '<meta property="og:image" content="'.IMAGE_PATH.'slideshow/'.$imgRec->image.'"/>'."\n";
	}
	else {
		$seoSources.= '<meta property="og:image" content="'.IMAGE_PATH.'preference/'.$config->logo_upload.'"/>'."\n";
	}	
	$seoSources.= '<meta property="og:description" content="'.$description.'" />'."\n";
	$seoSources.= '<meta property="og:url" content="'.curPageURL().'" />'."\n";
	$seoSources.= '<meta property="og:site_name" content="'.$config->sitename.'" />'."\n";
