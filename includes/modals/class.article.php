...
class Article extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'slug', 'title', 'sub_title', 'content', 'status', 'sortorder', 'meta_title', 'meta_keywords', 'meta_description', 'type', 'added_date', 'homepage', 'image');
