...
class Advertisement extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'title', 'position', 'image', 'img_height', 'img_width', 'date_from', 'date_to', 'url_link', 'notification', 'notif_status', 'mail_to', 'content', 'remarks', 'mail_status', 'status', 'added_date', 'sortorder');
