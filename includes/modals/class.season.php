...
class Season extends DatabaseObject {
	...
	protected static $table_name = "tbl_season";
	protected static $db_fields = array('id', 'season', 'date_from', 'date_to', 'status', 'sortorder', 'added_date');
	...
	//Get all the rows in the current database table.
