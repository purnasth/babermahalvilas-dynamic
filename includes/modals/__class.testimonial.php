...
class Testimonial extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'parentOf', 'name', 'content', 'status', 'sortorder', 'image', 'linksrc', 'country');
	...
	//GET ALL Testimonial 
	public static function get_alltestimonial($parentId=0){
		global $db;
		$sql="SELECT * FROM ".self::$table_name." WHERE parentOf=$parentId AND status=1 ORDER BY sortorder DESC";
