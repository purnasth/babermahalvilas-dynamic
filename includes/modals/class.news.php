...
class News extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'title', 'author', 'content', 'status', 'meta_keywords', 'meta_description', 'news_date', 'archive_date', 'sortorder', 'type', 'added_date', 'image', 'source');
	...
	public static function get_allnews(){
		global $db;
		$sql="SELECT * FROM ".self::$table_name." WHERE status='1' ORDER BY news_date DESC";
