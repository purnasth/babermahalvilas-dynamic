    ...
    <div class="example-code">
        ...
        <div class="form-row">
            ...
            <div class="form-input col-md-8">
                <input placeholder="http://www.longtail.info" class="col-md-6 validate[custom[url]]" type="text" name="url_link" id="url_link" value="<?php echo !empty($testimonialInfo->url_link)?$testimonialInfo->url_link:"";?>">
            </div>                
        </div>
