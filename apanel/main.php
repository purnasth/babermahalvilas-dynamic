                    ...
                    <div id="page-header" class="clearfix">
                        <div id="page-header-wrapper" class="clearfix">                           
                            ...
                            <div class="top-icon-bar">
                                ...
                                <a href="<?php echo HOTEL_ACCESS;?>" class="user-ico clearfix" title="LogIn : Hotel"><span><i class="glyph-icon icon-sign-out font-size-12" style="margin: 0px !important;"></i> Hotel</span></a>
