            ...
            <tr id="<?php echo $record->id;?>">
                ...
                <td class="text-center">
                    <span class="badge bg-orange tooltip-button mrg15R" title="No of Room Images" data-original-title="Badge with .bg-orange">
                        <?php $nos = unserialize($record->image); echo count($nos);?>
                    </span>
                </td>
                <td class="text-center">
					<?php	
    	...
    	<form action="" class="col-md-12 center-margin" id="subpackage_frm">        	
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Sub Package Title" class="col-md-6 validate[required,length[0,50]]" type="text" name="title" id="title" value="<?php echo !empty($subpackageInfo->title)?$subpackageInfo->title:"";?>">
                </div>                
            </div>   
            ...
            <div class="form-row">  
                ...
                <div class="form-checkbox-radio col-md-10 form-input">                    
                    <input type="text" placeholder="Title" class="col-md-4 validate[length[0,250]]" name="fparent[<?php echo $recRow->id;?>][]" value="<?php echo @$saveRec[$recRow->id][0][0];?>">
                    <div class="clear"></div>
                <?php $childRec = Features::get_all_byparnt($recRow->id);
                    if($childRec){
                        ...
                        foreach($childRec as $childRow){ 
                            $check='';
                            if($saveRec and @$saveRec[$recRow->id][1]){$check = (in_array($childRow->id,$saveRec[$recRow->id][1]))?'checked="checked"':''; } ?>
                            <input type="checkbox" class="custom-radio" name="feature[<?php echo $recRow->id;?>][]" value="<?php echo $childRow->id;?>" <?php echo $check;?>>
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-8">   
                   <textarea maxlength="210" class="character-brief validate[required,length[0,210]]" id="detail" name="detail" placeholder="Brief"><?php echo !empty($subpackageInfo->detail)?$subpackageInfo->detail:"";?></textarea>
                   <div class="brief-remaining clear input-description">210 characters left</div>
                </div>
            </div>    
            <div class="form-row">
            ...
            <?php $pkg = Package::find_by_id($pid);
            if($pkg->type==1):?>
            <h3>Extra Information For Booking</h3>
            <div class="form-row">
                <div class="form-label col-md-2">
                    <label for="">
                        No. of Rooms :
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-10">
                    <div class="col-md-3 hide rmovprice1">             
                        <label>1 no. of: </label>
                        <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text" name="room_price[0][]" id="room_price1" value="<?php echo !empty($subpackageInfo->onep_price)?$subpackageInfo->onep_price:'';?>">
                    </div>
                    <div class="col-md-3 hide rmovprice2">
                        <label>2 no. of: </label>
                        <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text" name="room_price[0][]" id="room_price2" value="<?php echo !empty($subpackageInfo->twop_price)?$subpackageInfo->twop_price:'';?>">
                    </div>
                    <div class="col-md-3 hide rmovprice3">
                        <label>3 no. of: </label>
                        <input placeholder="Price" class="validate[groupRequired,length[0,7]]" type="text" name="room_price[0][]" id="room_price3" value="<?php echo !empty($subpackageInfo->threep_price)?$subpackageInfo->threep_price:'';?>">
                    </div>
                </div>                
            </div> 
            <?php
