    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
        <thead>
            <tr>
               ...
               <th class="text-center">Sub Package</th>     
        ...
        <tbody>
            ...
            <tr id="<?php echo $record->id;?>">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <div class="infobox info-bg mrg0B">                                	
                                  	<img src="<?php echo IMAGE_PATH.'package/thumbnails/'.$record->image;?>"  style="width:100%"/>
                                    <span><?php echo $record->title;?></span>                              
                                </div>                                 
                            </li>
                        </ul>
                ...
                <td>
                	<a class="primary-bg medium btn loadingbar-demo" title="" onClick="viewSubpackagelist(<?php echo $record->id; ?>);" href="javascript:void(0);">
                        <span class="button-content">
                            <span class="badge bg-orange radius-all-4 mrg5R" title="" data-original-title="Badge with tooltip"><?php echo $countImages = Subpackage::getTotalSub($record->id);?></span>
        ...
        <form action="" class="col-md-12 center-margin" id="package_frm">
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Package Title" class="col-md-6 validate[required,length[0,200]]" type="text" name="title" id="title" value="<?php echo !empty($packageInfo->title)?$packageInfo->title:"";?>">
                </div>                
            </div>      
            <div class="form-row">
                <div class="form-label col-md-2">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Package Sub Title" class="col-md-6 validate[required,length[0,50]]" type="text" name="sub_title" id="sub_title" value="<?php echo !empty($packageInfo->sub_title)?$packageInfo->sub_title:"";?>">
                </div>                
            </div>                           
            <div class="form-row add-image">
                ...
                <div class="col-md-3" id="removeSavedimg<?php echo $packageInfo->id;?>">
                    <div class="infobox info-bg">                                                               
                        <div class="button-group" data-toggle="buttons">
                            ...
                            <a class="btn small float-right" href="javascript:void(0);" onclick="deleteSavedPackageimage(<?php echo $packageInfo->id;?>);">
                ...
                <div class="form-input col-md-10 uploader <?php echo !empty($packageInfo->image)?"hide":"";?>">          
                   <input type="file" name="package_upload" id="package_upload" class="transparent no-shadow">
                </div>                
                <!-- Upload user image preview -->
                <div id="preview_Image"><input type="hidden" name="imageArrayname" value="<?php echo !empty($packageInfo->image)?$packageInfo->image:"";?>" class="" /></div>
            </div>
            ...
            <?php $fctitle=''; $fcoptoin=array();
            if(!empty($packageInfo->facility) and $packageInfo->facility!='a:0:{}') {
                $fclty = unserialize($packageInfo->facility); 
                $fctitle = $fclty[0];
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Facility Title" class="col-md-6" type="text" name="facility[]" id="facility_title" value="<?php echo !empty($fctitle)?$fctitle:'';?>">
                </div>                
            </div>   

            <?php if(!empty($fcoptoin)) { $i=1;
                foreach($fcoptoin as $fck=>$fcval) { ?> 
                    <div class="form-row my-style" id="NewRow<?php echo $i;?>">     
                        <div class="form-label col-md-2">
                            <label for=""><?php echo ($i==1)?'Facility Options':'&nbsp;';?></label>
                        </div>           
                        <div class="form-input col-md-12" id="NewRow0">                    
                            <div class="col-md-4">
                                <input placeholder="Facility Options" type="text" name="facility[]" id="facility_opt" class="" value="<?php echo $fcval;?>">
                            </div>
                            <div>
                                <a href="javascript:void(0);" class="btn medium bg-blue" data-placement="right" title="Add" onclick="addnewRow();">
                                    <i class="glyph-icon icon-plus-square"></i>
                                </a>
                                <?php if($i!=1) { ?> 
                                <a href="javascript:void(0);" class="btn medium bg-red" data-placement="right" title="Delete" onclick="deletenewRow(<?php echo $i;?>);">
                ...
                <div class="form-row my-style">     
                    ...
                    <div class="form-input col-md-12" id="NewRow0">                    
                        <div class="col-md-4">
                            <input placeholder="Facility Options" type="text" name="facility[]" id="facility_opt" class="">
                        </div>
                        <div>
                            <a href="javascript:void(0);" class="btn medium bg-blue tooltip-button" data-placement="right" title="Add" onclick="addnewRow();">
                                <i class="glyph-icon icon-plus-square"></i>
                           </a>
                         </div>                                          
                     </div>                                  
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-8">   
                   <textarea placeholder="Brief" name="detail" id="detail" class="character-details validate[required,length[0,125]]" maxlength="125"><?php echo !empty($packageInfo->detail)?$packageInfo->detail:"";?></textarea>
                   <div class="description-remaining clear input-description">125 characters left</div>
                </div>
            </div>
            ...
            <div class="form-row">   
                ...
                <div class="form-input col-md-6">                    
                    <select name="dis_rate" class="col-md-4">
                        <option value="">Package Discount</option>
                        <?php for($i=5; $i<=100; $i+=5) {
                            $sel = (!empty($packageInfo->dis_rate) and $packageInfo->dis_rate==$i)?' selected':'';
                            echo '<option value="'.$i.'" '.$sel.'>'.$i.'%</option>';
                        } ?>
                    </select>
                    <br /><small>Valid only for rooms.</small>
                </div>                
            </div>  
            <div class="form-row">   
                <div class="form-label col-md-2">
            ...
            <div class="form-row <?php echo (!empty($packageInfo->meta_keywords) || !empty($packageInfo->meta_description) || !empty($packageInfo->meta_title))?'':'hide';?> metadata"> 
                <div class="col-md-12">  
                    <div class="form-input col-md-12">
                        <input placeholder="Meta Title" class="col-md-6 validate[required]" type="text" name="meta_title" id="meta_title" value="<?php echo !empty($packageInfo->meta_title)?$packageInfo->meta_title:"";?>">
                    </div>
                    <br />
                    <div class="form-input col-md-12"> 
                        <div class="row">
