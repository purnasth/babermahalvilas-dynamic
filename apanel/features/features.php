...
<a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="viewFeatureslist(0);">
...
<?php }?>
<a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="AddNewFeatures();">
    <span class="glyph-icon icon-separator">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
        ...
        <tbody>
            ...
            <tr id="<?php echo $record->id;?>">
                ...
                <td class="text-center"><img src="<?php echo IMAGE_PATH;?>features/<?php echo $record->image;?>" alt="<?php echo $record->title;?>" width="25"></td>               
...
<a class="loadingbar-demo btn medium bg-blue-alt float-right" href="javascript:void(0);" onClick="viewFeatureslist(<?php echo !empty($featuresInfo->parentId)?$featuresInfo->parentId:0;?>);">
    <span class="glyph-icon icon-separator">
        <i class="glyph-icon icon-arrow-circle-left"></i>
    </span>
    <span class="button-content"> Back </span>
        ...
        <form action="" class="col-md-12 center-margin" id="features_frm">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Features Title" class="col-md-6 validate[required,length[0,50]]" type="text" name="title" id="title" value="<?php echo !empty($featuresInfo->title)?$featuresInfo->title:"";?>">
                </div>                
            </div>                                 
            <div class="form-row add-image">
                ...
                <div class="col-md-1" id="removeSavedimg<?php echo $featuresInfo->id;?>">
                    <div class="infobox info-bg">                                                               
                        <div class="button-group" data-toggle="buttons">
                            ...
                            <a class="btn small float-right" href="javascript:void(0);" onclick="deleteSavedFeaturesimage(<?php echo $featuresInfo->id;?>);">
                                <i class="glyph-icon icon-trash-o"></i>
                            </a>                                                       
                        </div>
                        <img src="<?php echo IMAGE_PATH.'features/thumbnails/'.$featuresInfo->image;?>"  style="width:100%"/>                                                                                   
                    </div> 
                </div>
                <?php endif;?>
                ...
                <div id="preview_Image"><input type="hidden" name="imageArrayname" value="<?php echo !empty($featuresInfo->image)?$featuresInfo->image:"";?>" class="" /></div>
            </div> 
            ...
            <!-- <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Icon Name" class="col-md-6 validate[required,length[0,50]]" type="text" name="imageArrayname" id="imageArrayname" value="<?php echo !empty($featuresInfo->image)?$featuresInfo->image:"";?>">
                    <br /><small>Font Awesome icon name (eg: fa-glass/ <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet" target="_blank">link</a>) </small>
                </div>                
            </div> -->
            ...
            <input myaction='0' type="hidden" name="idValue" id="idValue" value="<?php echo !empty($featuresInfo->id)?$featuresInfo->id:0;?>" />
         </form>    
    </div>
</div>   
...
<script type="text/javascript">
   // <![CDATA[
    ...
    'formData'   : {PROJECT : '<?php echo SITE_FOLDER;?>',targetFolder:'images/features/',thumb_width:200,thumb_height:200},
    'method'     : 'post',
