...
$position = array(1=>'Main Slideshow');
    	...
    	<form action="" class="col-md-12 center-margin" id="slideshow_frm">
        	<div class="form-row">
                ...
                <div class="form-input col-md-8">
                    <input placeholder="Slideshow Title" class="col-md-6 validate[required,length[0,50]]" type="text" name="title" id="title" value="<?php echo !empty($advInfo->title)?$advInfo->title:"";?>">
                </div>                
            </div>             
                ...
                <div class="col-md-3" id="removeSavedimg1">
                    <div class="infobox info-bg">                            	                                
                        <div class="button-group" data-toggle="buttons">
                            ...
                            <a class="btn small float-right" href="javascript:void(0);" onclick="deleteSavedSlideshowimage(1);">
                                <i class="glyph-icon icon-trash-o"></i>
                            </a>                                                       
                        </div>
                        <img src="<?php echo IMAGE_PATH.'slideshow/thumbnails/'.$advInfo->image;?>"  style="width:100%"/>                                                                                   
                    </div> 
                </div>
                <?php endif;?>
