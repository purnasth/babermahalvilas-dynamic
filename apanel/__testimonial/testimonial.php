...
$moduleFoldername = "testimonial";		// Image folder name
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
        ...
        <tbody>
            <?php $parentId = (isset($_REQUEST['id']) and !empty($_REQUEST['id']))?addslashes($_REQUEST['id']):0;
                $records  =  Testimonial::find_all_byparnt($parentId);   
            ...
            <tr id="<?php echo $record->id;?>">
                ...
                <td class="text-center">
                    <?php $countChild = Testimonial::getTotalChild($record->id); 
                    $addfnc = ($countChild)?'onClick="viewsublist('.$record->id.');"':'';?>
                    <a class="primary-bg medium btn loadingbar-demo" title="" <?php echo $addfnc;?>  href="javascript:void(0);">
    	...
    	<form action="" class="col-md-12 center-margin" id="testimonial_frm">
        	<div class="form-row">
                ...
                <div class="form-input col-md-10">
                    <?php $selid = !empty($testimonialInfo->parentOf)?$testimonialInfo->parentOf:0; ?>
                    <select name="parentOf" class="col-md-4 activityfilter" selId="<?php echo $selid;?>">
                        <?php echo Testimonial::get_all_filterdata($selid); ?>
                    </select>
                </div>    
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-input col-md-6">
                    <input placeholder="Url Link (http://www.)" class="col-md-6 " type="text" name="linksrc" id="linksrc" value="<?php echo !empty($testimonialInfo->linksrc)?$testimonialInfo->linksrc:"";?>">                   
                </div>                
            </div>
    		...
    		<div class="form-row">
            	...
            	<div class="form-label col-md-6">                                                         
                    <textarea placeholder="Content" name="content" id="content" class="character-keyword validate[required,maxSize[250]]"><?php echo !empty($testimonialInfo->content)?$testimonialInfo->content:"";?></textarea>
