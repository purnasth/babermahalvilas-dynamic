...
if(!empty($Records)) { 
    $reslide.='<section id="slider" class="swiper_wrapper clearfix bgcolor-grey-dark">
        <div class="swiper-container swiper-parent">           
            ...
            <div class="swiper-button-prev" id="slider-arrow-left"><img src="template/cms/images/icons/arrow_left.png" alt="left" /></div>
            <div class="swiper-button-next" id="slider-arrow-right"><img src="template/cms/images/icons/arrow_right.png" alt="right" /></div>              
        </div>
